...
?>
                    <div class="box card text-white bg-secondary">
                        ...
                        <form class="form-group" action="" method="post">
                            ...
                            <input type="hidden" name="in_out_type" value="Out Temp">
                            <input class="form-control" type="text" name="youth_id" placeholder="Select here to check out temporarily" autofocus>
                        </form>
                    </div>
